    ...
    <ProjectTemplate
      ...
      purpose={
        <>
          ...
          to create a tool
          <br />
          that would make it easy to log scores, manage ongoing games, and look
          back <br />
      ...
      stackexp={
        <>
          ...
          <br />
          <br />
          <strong> Expo Go</strong> simplified the building process by managing
          <br />
      ...
      lessons={
        <>
          This was my first fully shipped mobile app — and what made me my first
          internet dollar.
          <br />
          <br />I learned how to scope a project tightly, prioritize user
          experience, and ship before it&apos;s “perfect.” It also taught me the
          process of submitting an app to the App Store, using local storage for
          persistent data, and gathering feedback from real users. Choosing a
          small but meaningful idea that solved a real need — in this case, for
          friends and family — made development faster and more focused.
          <br />
          However probably the most important thing I&apos;ve learned from
          launching this app is that I am an app developer. I am not only
          capable but I&apos;m becoming more confident in my ability to <br />
