      ...
      <ProjectTemplate
        ...
        description={
          <>
            ...
            <br />
            <br />
            It&apos;s a simple auto-clicker tool for macOS that lets users set
            up automatic mouse clicks at customizable intervals — useful for
            idle games, repetitive tasks, or accessibility needs.
            <br />
            <br />
            Apple rejected it under Guideline 2.5.1 for using accessibility APIs
            in an &quot;unapproved manner.&quot; Since the app can&apos;t be
            distributed through the Mac App Store, I&apos;m making it available
        ...
        purpose={
          <>
            ...
            repetitive clicks on macOS. Whether you&apos;re grinding through an
            idle game, testing UI interactions, or have accessibility needs that
            require automated input, there wasn&apos;t a clean native solution
            available.
            <br />
            <br />I wanted to build something{" "}
            <strong>lightweight and focused</strong>
            — no bloat, no ads, just a tool that does one thing well. Users can
            configure the click interval, set a target location on screen, and
        ...
        stackexp={
          <>
            ...
            <strong>Accessibility APIs</strong> (CGEvent) to programmatically
            generate click events. This is the same system that powers assistive
            technologies like Switch Control and Voice Control — legitimate
            tools for users who can&apos;t interact with their devices
            conventionally.
            <br />
            <br />
            ...
            showing the click location. SwiftUI made it easy to build a
            responsive menu bar app that stays out of the way until needed.
            <br />
            <br />
        ...
        problems={
          <>
            ...
            <em>only</em> way to achieve this functionality on macOS —
            there&apos;s no alternative approach I found that would satisfy both
            the technical requirements and Apple&apos;s guidelines.
            <br />
            <br />
        ...
        img4="/images/autoclicker/autoclicker-promo.png"
        lessons={
          <>
            This project taught me a lot about the realities of macOS
            ...
            their platform. It&apos;s a reminder that when you build for someone
            else&apos;s ecosystem, you play by their rules.
            <br />
            <br />
            <strong>
              Accessibility APIs are powerful but restricted.
            </strong>{" "}
            macOS gives developers access to some incredible system-level
            features, but Apple is protective about how they&apos;re used.
            Understanding the line between &quot;intended&quot; and
            &quot;unapproved&quot; use isn&apos;t always clear until you hit the
            review process.
            <br />
            <br />
            <strong>Distribution alternatives exist.</strong> Just because an
            app can&apos;t go on the Mac App Store doesn&apos;t mean it
            can&apos;t reach users. Direct distribution outside the App Store is
            a viable option for macOS apps that Apple won&apos;t approve.
            <br />
            <br />
            Despite the rejection, I&apos;m proud of what I built. It works, I
            still use it all the time, and I learned a ton in the process.
          </>
        }
      />
    </div>
